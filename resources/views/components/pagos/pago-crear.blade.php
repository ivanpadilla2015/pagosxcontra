...
new class extends Component
{
    ...
    public function confirmarPago(): void
    {
        ...
        try {
            ...
            $pago = Pago::with(['detalles.factura.lineas.itemcontrato.movirubro', 'detalles.factura.lineas.movirubro.rubro'])->findOrFail($this->pago_id);
            ...
            $pago->load('detalles.factura.lineas.movirubro.rubro');
