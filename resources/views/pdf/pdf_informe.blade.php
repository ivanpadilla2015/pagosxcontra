...
<html lang="en">
  ...
  <body>
      ...
      <br> <br>
      @php 
        $siesnum = is_numeric(substr($data->contrato->numcontrato,0,3))       ;  
      @endphp  

      <div align="justify" >{{"Con toda atención me permito enviar al señor ". $data->user->regional->director->nombre_director.", el informe de supervisión No.".$data->cansecu_infor}} @if ($siesnum) {{ " Del Contrato No ".$data->contrato->numcontrato }} @else {{ " De La ".$data->contrato->numcontrato}} @endif   Correspondiente {{$data->corresponde_texto_periodo}}, de acuerdo con la siguiente información:</div>
      ...
      <br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Porcentaje cumplimiento Avance %</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  {{ $action = ($data->porcentaje_cumplimiento < 0) ? "0" : number_format($data->porcentaje_cumplimiento, 2, ',', '.') }}% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Demora _____________%  
      <br><br>
...
adicionales estipuladas en el contrato.</td>
      ...
      <div class="centra_div">
          ...
          <div  >  
            ...
            <div>Supervisor @if ($siesnum) {{ " Del Contrato No ".$data->contrato->numcontrato}} @else {{ " De La ".$data->contrato->numcontrato}} @endif  </div>
          </div>
       </div>
